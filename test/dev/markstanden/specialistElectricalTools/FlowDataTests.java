...
public class FlowDataTests {
	...
	final String BASE_DATESTRING = "2021-12-01T08:00:00Z";

	@Test
	public void checkRelativePathFromFullFilePath() {
		boolean isFolder = false;
		FlowData flowData = new FlowData(BASE_FULLFILEPATH, BASE_DATESTRING, isFolder);
	...
	public void checkFolderFromFolderPath() {
		...
		FlowData flowData = new FlowData(BASE_FULLFOLDERPATH, BASE_DATESTRING, isFolder);
		assertEquals(BASE_FOLDER, flowData.getItemString());
	}
	...
	public void checkValidDateGMTTimezone() {
		final String dateString = "2021-12-01T08:30:59Z";
		boolean isFolder = false;
		FlowData flowData = new FlowData(BASE_FULLFILEPATH, dateString, false);
